...
var HTMLprojectImage = '<a href="#" target="_blank" class="project-demo-link"><img src="%data%" width="280" class="project-image" alt="project image"></a>';
...
function initializeMap() {
  ...
  */
  ...
  // array location strings returned from locationFinder()
...
window.addEventListener('resize', function(e) {
  //map bounds gets updated on page resize
